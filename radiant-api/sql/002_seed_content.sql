...
values (
    ...
    'Base inicial para raciocinio radiologico e introducao a TC.',
    1,
    true
)
...
(
    ...
    $${
      ...
      "journey": {
        "intro": {
          "questionIndex": 0,
          "contextBody": "Você vai começar pelo papel dos raios-X e pelo raciocínio básico de contraste e radiopacidade.",
          "teachBody": "Radiologia diagnóstica existe para tornar estruturas internas visíveis de modo comparável, útil e clinicamente interpretável.",
          "reinforceBody": "O valor do exame está em distinguir estruturas internas com contraste suficiente para guiar decisão clínica."
        },
        "review": {
          "questionIndex": 1,
          "contextBody": "Retome rapidamente o conceito central antes de seguir adiante.",
          "reinforceBody": "Quando a densidade sobe, a estrutura tende a absorver mais raios-X e aparecer mais radiopaca."
        }
      },
      "questions": [
        {
        ...
        },
        {
          ...
          "explanation": "O osso é a estrutura mais radiopaca devido à sua alta densidade e conteúdo de cálcio, que absorve mais raios-X."
        },
        {
          "id": "q3",
          "type": "multiple-choice",
...
(
    'lesson-2',
    'track-radiology-foundations',
    'principios-de-tomografia-computadorizada',
    ...
    $${
      ...
      "journey": {
        "intro": {
          "questionIndex": 2,
          "contextBody": "Agora você entra no raciocínio seccional da tomografia e nas diferenças entre voxel, atenuação e sobreposição.",
          "teachBody": "A tomografia reduz a sobreposição anatômica ao gerar cortes, o que muda a clareza com que enxergamos estruturas internas.",
          "reinforceBody": "Cada corte melhora a leitura anatômica ao reduzir a mistura de estruturas no mesmo plano de imagem."
        },
        "review": {
          "questionIndex": 0,
          "contextBody": "Faça uma verificação rápida do conceito mais importante desta etapa.",
          "reinforceBody": "Voxel é a unidade volumétrica que sustenta a leitura seccional da tomografia."
        }
      },
      "questions": [
        {
          ...
          "correctAnswerIndex": 1,
          "explanation": "Voxel é a menor unidade volumétrica da imagem tomográfica, equivalente tridimensional do pixel."
        },
        {
          "id": "ct-q2",
          "type": "multiple-choice",
          ...
          "correctAnswerIndex": 1,
          "explanation": "O ar apresenta atenuação muito baixa na tomografia e, por isso, aparece com densidade bastante escura."
        },
        {
          "id": "ct-q3",
          "type": "multiple-choice",
          ...
          "correctAnswerIndex": 2,
          "explanation": "A TC produz cortes seccionais, reduzindo a sobreposição anatômica e melhorando a avaliação de estruturas internas."
        }
      ]
    }$$::jsonb,
    true
