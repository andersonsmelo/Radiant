...
- [E2E iOS da primeira vitória — 2026-08-09](2026-08-09-primeira-vitoria-ios.md)
  ...
  simulador iOS 26.5; o registro Android acima completa a nova matriz do flow.
...
- [B4 — VoiceOver, item 2 do Gate 2 — 2026-08-06](2026-08-06-b4-voiceover-item2.md)
  — nome, função, dica e desabilitado ouvidos em controles reais; o estado
  ocupado fechado por contrato unitário **porque não é produzível nesta build**,
  com gatilho de reabertura escrito.
