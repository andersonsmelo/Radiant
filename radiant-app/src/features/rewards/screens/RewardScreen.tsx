                  ...
                  <View style={{ flex: 1 }}>
                    <Text style={styles.rewardCardTitle}>
                      {(gamification?.streakDays ?? 0) === 1
                        ? 'Sequência de 1 dia mantida'
                        : `Sequência de ${gamification?.streakDays} dias mantida`}
                    </Text>
                    <Text style={styles.rewardCardSub}>Volte amanhã para continuar</Text>
                  </View>
                </View>
              )}
            </View>
