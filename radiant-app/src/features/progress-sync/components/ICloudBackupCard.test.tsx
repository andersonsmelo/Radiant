...
describe('ICloudBackupCard', () => {
    it('desligado: interruptor apagado e sem data', () => {
        ...
        render(<ICloudBackupCard state={{ decided: true, enabled: false, lastBackupAt: null, lastError: null }} onToggle={onToggle} />);
    ...
    it('ativo: mostra a data do último backup', () => {
        render(<ICloudBackupCard state={{ decided: true, enabled: true, lastBackupAt: '2026-09-14T12:00:00.000Z', lastError: null }} onToggle={jest.fn()} />);
    ...
    it('erro: informa sem bloquear e mantém o interruptor', () => {
        render(<ICloudBackupCard state={{ decided: true, enabled: true, lastBackupAt: null, lastError: 'cloud-unavailable' }} onToggle={jest.fn()} />);
    ...
    it('falha genérica informa o que fazer', () => {
        render(<ICloudBackupCard state={{ decided: true, enabled: true, lastBackupAt: '2026-09-13T12:00:00.000Z', lastError: 'failed' }} onToggle={jest.fn()} />);
...
it('avisa que o backup é de uma versão mais nova sem sugerir nova tentativa', () => {
    ...
    render(
        <ICloudBackupCard
            state={{ decided: true, enabled: true, lastBackupAt: null, lastError: 'incompatible' }}
            onToggle={jest.fn()}
        />,
    );
