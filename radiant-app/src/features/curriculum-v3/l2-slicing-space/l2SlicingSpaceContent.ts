...
export const L2_SLICING_SPACE: L2SlicingSpaceLesson = {
  ...
  challenges: [
    ...
    item({
      ...
      answerOptions: pair(coronal, transverse), correctAnswerId: 'coronal', evidenceKind: 'later_independent_retrieval', awardsXp: true, misconception: 'E-PLN-SEC',
    ...
    item({
      ...
      answerOptions: pair(coronal, oblique), correctAnswerId: 'oblique', evidenceKind: 'later_independent_retrieval', awardsXp: true, misconception: 'E-PLN-OBL',
    ...
    item({
      ...
      answerOptions: pair(resultingImage, regionWithThickness), correctAnswerId: 'region-with-nominal-thickness', evidenceKind: 'later_independent_retrieval', awardsXp: true, misconception: 'E-PLN-SEC',
